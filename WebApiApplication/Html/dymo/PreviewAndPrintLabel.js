...
(function()
{
    ...
    function onload()
    {
        ...
        var acbsName = document.getElementById('acbsName');
        ...
        //{
        //    updatePriviewSection();
        //};

        acbsNo.onkeyup = function () {
            updatePriviewSection();
        };
        
        function updatePriviewSection() {
            ...
            if (labelFile.files && labelFile.files[0] && typeof labelFile.files[0].getAsText == "function") // Firefox
            {
                ...
                if ((fileName.indexOf('/') >= 0 || fileName.indexOf('\\') >= 0) && (fileName.indexOf('fakepath') < 0)) {
                    ...
                    var acbsNo = document.getElementById('acbsNo').value;
    ...
    <DieCutLabel Version="8.0" Units="twips">\
        ...
        <ObjectInfo>\
            ...
            updatePreview();
            //acbsName.value = getAddress();
            printButton.disabled = false;
            //acbsName.disabled = false;
        }

        // updates address on the label when user types in textarea field
        acbsName.onkeyup = function()
        {
            //if (!label)
            //{
